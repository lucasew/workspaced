...
// treat it as a backend id (see internal/tool), while module/source call sites treat
// it as a source provider id (see internal/modfile). Bare names default to scheme
